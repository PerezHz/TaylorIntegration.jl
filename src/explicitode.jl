...
is used as the time step.
"""
function taylorstep!{T<:Number}(f, xT::Vector{Taylor1{T}}, t0::T, t1::T, x0::Array{T,1},
        order::Int, abstol::T)
    @assert t1 > t0
...
function taylorstep!{T<:Real}(f, xT::Vector{Taylor1{Complex{T}}}, t0::T, t1::T, x0::Array{Complex{T},1},
        order::Int, abstol::T)
    @assert t1 > t0

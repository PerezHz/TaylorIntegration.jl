...
# __jetcoeffs
"""
    __jetcoeffs!(f, t, x, ::Val{bool})
    __jetcoeffs!(f, t, x, dx, xaux, ::Val{bool})

Chooses a method of [`jetcoeffs!`](@ref) (hard-coded or generated by
[`@taylorize`](@ref)) depending on `bool::Bool`.
"""
__jetcoeffs!(f, t, x, ::Val{false}) = jetcoeffs!(f, t, x)
__jetcoeffs!(f, t, x, ::Val{true}) = jetcoeffs!(t, x, Val(f))
__jetcoeffs!(f!, t, x, dx, xaux, ::Val{false}) = jetcoeffs!(f!, t, x, dx, xaux)
__jetcoeffs!(f!, t, x, dx, xaux, ::Val{true}) = jetcoeffs!(t, x, dx, Val(f!))
...
function taylorstep!(f, t::Taylor1{T}, x::Taylor1{U}, t0::T, t1::T, x0::U,
    ...
    __jetcoeffs!(f, t, x, Val(parse_eqs))
...
function taylorstep!(f!, t::Taylor1{T}, x::Vector{Taylor1{U}}, dx::Vector{Taylor1{U}},
    ...
    # Compute the Taylor coefficients
    __jetcoeffs!(f!, t, x, dx, xaux, Val(parse_eqs))
...
function taylorinteg(f, x0::U, t0::T, tmax::T, order::Int,
    ...
    try
        jetcoeffs!(t, Taylor1( x0, order ), Val(f))
    catch
        parse_eqs = false
    end

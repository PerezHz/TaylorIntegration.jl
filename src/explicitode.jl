...
"""
@inline __jetcoeffs!(::Val{false}, f, t, x, params, tmpTaylor, arrTaylor) =
    jetcoeffs!(f, t, x, params)
@inline __jetcoeffs!(::Val{true},  f, t, x, params, tmpTaylor, arrTaylor) =
    jetcoeffs!(Val(f), t, x, params, tmpTaylor, arrTaylor)
@inline __jetcoeffs!(::Val{false}, f, t, x, dx, xaux, params, tmpTaylor, arrTaylor) =
    jetcoeffs!(f, t, x, dx, xaux, params)
@inline __jetcoeffs!(::Val{true},  f, t, x, dx, xaux, params, tmpTaylor, arrTaylor) =
...
function taylorstep!(f, t::Taylor1{T}, x::Taylor1{U}, abstol::T, params,
    ...
    __jetcoeffs!(Val(parse_eqs), f, t, x, params, tmpTaylor, arrTaylor)
...
function taylorstep!(f!, t::Taylor1{T}, x::Vector{Taylor1{U}},
    ...
    # Compute the Taylor coefficients
    __jetcoeffs!(Val(parse_eqs), f!, t, x, dx, xaux, params, tmpTaylor, arrTaylor)

...
@inline __jetcoeffs!(
    ::Val{false}, f, t, x, dx, xaux, params, rv) = jetcoeffs!(f, t, x, dx, xaux, params)
@inline __jetcoeffs!(
    ::Val{true}, f, t, x, dx, xaux, params, rv) = jetcoeffs!(Val(f), t, x, dx, params, rv)

# _allocate_jetcoeffs! fallbacks; needed to define the corresponding parsed method
@inline _allocate_jetcoeffs!(::Taylor1{T}, x::Taylor1{S}, params) where {
    T, S} = RetAlloc{Taylor1{S}}()

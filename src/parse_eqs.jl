...
function, together with a method of [`_allocate_jetcoeffs!`](@fef) to
improve allocations. Integrating via [`taylorinteg`](@ref) of
...
whose signature is `f(dq, q, params, t, rv::RetAlloc)` which should

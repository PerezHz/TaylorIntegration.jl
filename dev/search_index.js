...
{
    "location": "api/#TaylorIntegration.taylorstep!-Union{Tuple{U}, Tuple{T}, Tuple{Any,Taylor1{T},Taylor1{U},T,T,Int64,T,Any}, Tuple{Any,Taylor1{T},Taylor1{U},T,T,Int64,T,Any,Bool}} where U<:Number where T<:Real",
    "page": "API",
    "title": "TaylorIntegration.taylorstep!",
    "category": "method",
    "text": "taylorstep!(f, t, x, t0, t1, order, abstol, params, parse_eqs=true) -> δt\ntaylorstep!(f!, t, x, dx, xaux, t0, t1, order, abstol, params, parse_eqs=true) -> δt\n\nOne-step Taylor integration for the one-dependent variable ODE dotx=dxdt=f(x p t) with initial conditions x(t_0)=x_0, computed from t0 up to t1. Returns the time-step δt of the actual integration carried out.\n\nHere, f is the function defining the RHS of the ODE (see taylorinteg), t is the independent variable, x contains the Taylor expansion of the dependent variable, order is the degree  used for the Taylor1 polynomials during the integration abstol is the absolute tolerance used to determine the time step of the integration, and params are the parameters entering the ODE functions. If the time step is larger than t1-t0, that difference is used as the time step. For several variables, dx and xaux, both of the same type as x, are needed to save allocations. Finally, parse_eqs is a switch to force not using (parse_eqs=false) the specialized method of jetcoeffs! created with @taylorize; the default is true (parse the equations). Finally, parse_eqs is a switch to force not using (parse_eqs=false) the specialized method of jetcoeffs! created with @taylorize; the default is true (parse the equations).\n\n\n\n"
},
